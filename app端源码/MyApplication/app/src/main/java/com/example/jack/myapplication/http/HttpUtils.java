package com.example.jack.myapplication.http;
...
//        }
    ...
    public static HttpClient getClient() throws Exception{
        ...
        HttpConnectionParams.setConnectionTimeout(params, 5000);//设置客户端与服务器的超时时间--->ConnectionTimeoutException
        HttpConnectionParams.setSoTimeout(params,5000);//设置服务器响应的超时时间--->SocketTimeoutException
